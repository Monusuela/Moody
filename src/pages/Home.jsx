              ...
              <Container>
                  ...
                  <Flex justify={"space-between"} gap={23} align={"center"} className={`Cards__row`} wrap={"wrap"}>
                      <Cart type={"common"} href={"#"} title={`DECOR`}
                            ...
                            image={CartImage1}/>
                      <Cart type={"product"} vertical image={Product1} title={`LINEN BEACH TOWEL`} stars={4} price={30}
                            href={"#"}/>
                      <Cart type={"product"} vertical image={Product1} title={`LINEN BEACH TOWEL`} stars={4} price={30}
                            href={"#"}/>
                      <Cart type={"product"} vertical image={Product1} title={`LINEN BEACH TOWEL`} stars={4} price={30}
          ...
          <section className="Top-rating">
              <Container>
                  ...
                  <Flex gap={25} wrap={"wrap"} align={"center"} className={"Top-rating__row"}>
                      <Cart type={"product"} horizontal image={Product2} href={"#"} title={`Tray with Foot`} price={30}
                            stars={4}/>
                      <Cart type={"product"} horizontal image={Product2} href={"#"} title={`Tray with Foot`} price={30}
                            stars={4}/>
                      <Cart type={"product"} horizontal image={Product2} href={"#"} title={`Tray with Foot`} price={30}
